  ...
  <div id="content" class="app-content box-shadow-z2 bg pjax-container" role="main">
    <div class="app-header white bg b-b">
          <div class="navbar" data-pjax>
                ...
                <div class="navbar-item pull-left h5" id="pageTitle">Search Notesheet</div>
                <!-- nabar right -->
...
<br>  
      <table class='table table-responsive table-striped b-t b-b table-hover ' id='myTable'> 
        ...
        <thead>
          <tr>
            ...
            <th  style="width:10%">Notesheet Number/नोटशीट संख्या</th>
            <th  style="width:10%">Subject/विषय</th>
            <th  style="width:10%">Date/दिनांक</th>
            <th  style="width:15%">Creator/निर्माता</th>
  ...
  $user_id=$_SESSION["user_id"];
       ...
       //     die(json_encode($response));
          ...
          $get_inbox='SELECT n.id, n.number, n.subject, n.date_created, u.user_name, file_id from notesheet n inner join user u on u.user_id=n.created_by order by date_created desc';
