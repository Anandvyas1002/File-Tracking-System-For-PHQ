      ...
      <table class='table table-responsive table-striped b-t b-b table-hover ' id='myTable'> 
        ...
        <thead>
          <tr>
            ...
            <th  style="width:15%">Dispatch Time/समय</th>
       ...
       //     die(json_encode($response));
          ...
          $get_inbox='select nt.id, n.number, n.subject, u.user_name,  nt.dispatch_time, "Sent" as "status" from user u inner join notesheet_transactions nt on nt.receiver_id=u.user_id inner join notesheet n on nt.notesheet_id=n.id where nt.Sender_id='.$user_id;
