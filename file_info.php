  ...
  <div class="box">
   ...
   <br>
      ...
      <div class="row container">
        <div class="col-sm-12">
          <strong>Linked notesheets/जुडी हुई  नोटशीट :</strong><br><br>
          <table class="table table-bordered table-hover">
            <thead>
              <th>ID</th>
              <th>Notesheet Number/नोटशीट संख्या</th>
              <th>Created by/निर्माता</th>
              <th>Remark/टिप्पणी</th>
              <th>Date  Created/निर्माण दिनांक</th>
            </thead>
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary p-x-md">Forward/पंजी आगे बढ़ाए</button>
			</form>
          </div>
        </div><!-- /.modal-content -->
      </div>
  ...
  <div class="row-col h-v">
    <div class="row-cell v-m">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
          	<h5 class="modal-title">Reply to sender/प्रेषक को जवाब दे</h5>
          </div>
          <div class="modal-body">
		    <form method="post" action="php/forward_file.php">
               <div class="md-form-group float-label">
