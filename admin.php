      ...
      <table data-ui-jp="dataTable" data-ui-options="{
        ...
        <thead>
          <tr>
            ...
            <th  style="width:35%">Username/नाम</th>
            <th  style="width:25%">Mobile</th>
            <th  style="width:15%">Supervisor/पर्यवेक्षक</th>
            <th  style="width:15%">Role/उपयोगकर्ता भूमिका</th>
          </tr>
        </thead>
        <tbody>
        </tbody>
    ...
    <div id="switcher">
      <div class="switcher dark-white" id="sw-theme">
        ...
        <div class="box-header">
          ...
          <strong>Theme Switcher/प्रदर्शन बदले</strong>
        </div>
