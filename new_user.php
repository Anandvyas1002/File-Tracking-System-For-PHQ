  ...
  <form method="post" action="php/register_user.php">
        <div class="box">
          <div class="box-header">
            <h2>Register User/उपयोगकर्ता पंजीकृत करें</h2>
          </div>
          <div class="box-body">
            <p class="text-muted">Please fill the information to continue</p>
            <div class="form-group">
              <label>User's Name/उपयोगकर्ता का नाम</label>
            ...
            <div class="form-group">
              <label>Supervisor/पर्यवेक्षक</label>
            ...
            <div class="form-group">
              <label>User Role/उपयोगकर्ता भूमिका</label>
          ...
          <div class=" p-a text-right">
            <button type="reset" class="btn default">Clear/हटाएँ</button>
            <button type="submit" class="btn btn-primary">Submit/जमा करें</button>
          </div>
        </div>
      </form>
</div>
