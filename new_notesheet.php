  ...
  <form method="post" action="php/register_notesheet.php" enctype="multipart/form-data">
        <div class="box">
          <div class="box-header">
            <h2>Register Notesheet/नोटशीट पंजीकरण</h2>
          </div>
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label>Notesheet Number/नोटशीट क्रमांक</label>
          ...
          <div class=" p-a text-right">
            ...
            <input type="submit" class="btn btn-primary" value="Save Notesheet/परिवर्तन सहेजे">
          </div>
        </div>
      </form>
</div>
